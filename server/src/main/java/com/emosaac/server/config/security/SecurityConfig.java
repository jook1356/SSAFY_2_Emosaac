...
//                .cors()
                ...
                .permitAll()
                .antMatchers("/api/emopicks", "/api/books/**", "/api/genres", "/api/books/platform", "/api/books/newbook")
                .permitAll()
                .anyRequest()
                .authenticated()
                .and()
    ...
    CorsConfigurationSource corsConfigurationSource(){
        ...
        corsConfiguration.setAllowedOrigins(List.of("http://localhost:3000", "https://j8d203.p.ssafy.io", "http://j8d203.p.ssafy.io:8081", "http://j8d203.p.ssafy.io:3000"));
