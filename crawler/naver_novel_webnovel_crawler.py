...
URL = 'https://novel.naver.com/best/genre?order=Update&finish=false&genre='
...
genreCode = ['101', '109', '102', '110', '103', '104', '106']
    ...
    for p in range(1, 31):
        ...
        # try:
            ...
            for j in range(1, 26):
                ...
                # title1 = driver.find_element(By.XPATH,f'//*[@id="content"]/div/ul/li[{j}]/div/h3/a').text
