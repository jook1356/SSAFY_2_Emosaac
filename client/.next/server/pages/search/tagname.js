...
const tagName = ({ type , tagName , data  })=>{
    ...
    const josa = (0,_components_search_batchim__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .Z)(tagName);
...
const getServerSideProps = async (context)=>{
    ...
    if (typeof type == "string" && typeof tagName == "string") {
        const data = await (0,_api_search__WEBPACK_IMPORTED_MODULE_4__/* .getListByTagName */ .n)(type, tagName, prevId, prevScore, size).then((res)=>{
            return res;
        });
        return await {
            props: {
...
var __webpack_exports__ = __webpack_require__.X(0, [932,394,17,701], () => (__webpack_exec__(8713)));
