...
async function getListByContent({ type , content , prevId , prevScore , size , token  }) {
    try {
        const headers = {};
        if (token) {
            headers.Authorization = token;
        }
        const { data  } = await _instance__WEBPACK_IMPORTED_MODULE_0__/* .defaultAxiosInstance.get */ .EC.get(`/search/title/${type}/${content}?prevId=${prevId}&prevScore=${prevScore}&size=${size}`, {
            headers
        });
        if (data.status === 200) {
            return data.data;
...
/* harmony import */ var _api_search_getSearchBooksByContent__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(3247);
...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_api_search_getSearchBooksByContent__WEBPACK_IMPORTED_MODULE_4__, _api_instance__WEBPACK_IMPORTED_MODULE_8__]);
([_api_search_getSearchBooksByContent__WEBPACK_IMPORTED_MODULE_4__, _api_instance__WEBPACK_IMPORTED_MODULE_8__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
const content = ({ type , content , data  })=>{
    ...
    const josa = (0,_components_search_batchim__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Z)(content);
    ...
    function getSearchBooks(prevId, prevScore) {
        ...
        (0,_api_search_getSearchBooksByContent__WEBPACK_IMPORTED_MODULE_4__/* .getListByContent */ .R)({
            type,
            content,
            prevId,
            prevScore,
...
const getServerSideProps = async (context)=>{
    ...
    if (typeof type == "string" && typeof content == "string") {
        ...
        const data = await (0,_api_search_getSearchBooksByContent__WEBPACK_IMPORTED_MODULE_4__/* .getListByContent */ .R)({
            type,
            content,
            prevId,
            prevScore,
...
var __webpack_exports__ = __webpack_require__.X(0, [394,932,878,17,674], () => (__webpack_exec__(3337)));
