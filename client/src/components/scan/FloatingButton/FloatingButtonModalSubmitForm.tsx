...
const FloatingButtonModalSubmitForm = ({
  modalHandler,
  phaseHandler,
  onClickSubmitHandler,
  isDarkMode,
}: FloatingButtonModalSubmitFormProps) => {
  ...
  const onClickImageChange = (event: React.ChangeEvent<HTMLInputElement>) => {
      ...
      <div css={descDetailWrapperCSS}>
        ...
        <div css={descStringWrapperCSS}>
          ...
          <div
            ...
            `}
          >
            웹툰의 제목이 포함된 보관함이 잘 보이게 스크린샷을 찍고, 스캔을
            시작하세요!
          </div>
        </div>
      </div>
    ...
    <>
      <div>
        <div css={headerCSS}>
          <img
            ...
            src={
              isDarkMode === true
                ? "/assets/scan_icon_white.png"
                : "/assets/scan_icon.png"
            }
          />
          <div css={headerTitleCSS}>작품 스캔</div>
        ...
        <div css={bodyCSS}>
          ...
          <div css={radioButtonSectorCSS}>
            ...
            <div css={radioButtonInnerSectorCSS}>
              ...
              >
                {contentType === 0 ? (
                  <MdCookie css={iconCSS} size={36} />
                ) : (
                  <MdOutlineCookie css={iconCSS} size={36} />
                )}
              ...
              >
                {contentType === 1 ? (
                  <RiBookReadFill css={iconCSS} size={36} />
                ) : (
                  <RiBookReadLine css={iconCSS} size={36} />
                )}
      ...
      <div css={footerCSS}>
        ...
        <Button
          ...
          height={"48px"}
          onClick={() => {
            onClickSubmitHandler({ image, contentType });
          }}
        >
          제출
        </Button>
...
const radioButtonWrapperCSS = ({
  ...
  return css`
    ...
    align-items: center;
    background-color: ${targetType === currentType
      ? `var(--main-color)`
      : `var(--border-color-2)`};
    cursor: pointer;
  `;
